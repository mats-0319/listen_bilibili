...
2. 某知名网络小说网站，签约合同中将小说作者创作内容的版权据为己有，使创作者变成了自带创意的枪手
3. 某知名网络小说网站，在网站订阅作品，实际上只获得了15天的阅读权，15天之后，网站甚至可以随意删除你购买的内容
...
又因为我在一些场景中确实有听音乐的需求——比如做家务的时候，而现有音乐播放器或多或少都不符合我的要求：

1. 网易云、酷狗等传统音乐播放器因为版权问题导致曲库不完整，可能你喜欢一首歌，这个播放器直接就没有，或者今天有但是过两天又下架了
2. [listen1](https://github.com/listen1/listen1_desktop)，这只是一个聚合平台，本质上还是使用其他播放器的音源
3. B站，在一个100首歌的合集里找到一首自己不喜欢的歌可太简单了，B站听歌的问题在于up主上传什么、我就得听什么，没有办法跳过一首歌、修改播放顺序、修改音量等
